...
function App() {
  ...
  return (
    <div className="App  p-8 ">
      <div className="text-5xl  py-10 font-bold mb-4">
        Password Generator
      </div>
      ...
      <button className='bg-green-600' onClick={generatePassword}>Generate Password</button>
      <div className=' mt-16 border rounded-lg'>
        {password && (
          <div className='my-4'>
            ...
            <button className='' onClick={() => navigator.clipboard.writeText(password) && toast.success('Password copied to clipboard!')}><FaCopy /></button>
          </div>
        )}
      </div>
    </div>
